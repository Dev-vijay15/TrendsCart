      ...
      <div class="tab-content pt-2" id="login_register_tab_content">
        <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
          <div class="register-form">
            <form method="POST" action="{{ route('admin.register') }}" name="register-form" class="needs-validation" novalidate="">
                @csrf
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray " name="first_name" value="" required="" autocomplete="name"
                  autofocus="">
                <label for="name">First Name</label>
              </div>
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray " name="last_name" value="" required="" autocomplete="name"
                  autofocus="">
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{ route('admin.login') }}" class="btn-text js-show-register">Login to your Account</a>
              </div>
            </form>
          </div>
        </div>
