            ...
            <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                    ...
                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                        ...
                        <li>
                            <div class="text-tiny">Add Role</div>
                        </li>
                    </ul>
                </div>

                <!-- form-add-product -->
                <form id="role-form" class="tf-section-2 form-add-product" method="POST">
                    @csrf
                    <div class="wg-box">
                        <fieldset class="name">
                            ...
                            @if ($permissions->isNotEmpty())
                                @foreach ($permissions as $permission)
                                    <div class="checkbox-item">
                                        <input type="checkbox" class="permission-checkbox" name="permission[]"
                        ...
                        <div class="cols gap10">
                            <button class="tf-button w-full" type="submit">Add Role</button>
                        </div>
                    </div>
                </form>
                <!-- /form-add-role -->
    ...
    <script>
        $(document).ready(function() {
            $('#role-form').on('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You are about to add this role!",
                    icon: 'warning',
