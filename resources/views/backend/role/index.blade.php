        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">All Roles</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href=" {{ route('role.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                <button type="button" class="show" data-id="{{ $role->id }}">
                                                    <div class="item eye">
                                                        <i class="icon-eye"></i>
                                                    </div>
                                                </button>
                                                ...
                                                <button type="button" class="delete" data-id="{{ $role->id }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content rounded-3 shadow-lg">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white" id="RoleModalLabel">Role Details</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete', function() {
                var roleId = $(this).data('id'); // Get ID from data attribute
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('role.destroy', ':id') }}".replace(':id',
                                roleId),
                            method: "DELETE",
                            data: {
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.show', function() {
                ...
                $.ajax({
                    url: "{{ route('role.show', ':id') }}".replace(':id', roleId),
                    method: "GET",
                    success: function(response) {
